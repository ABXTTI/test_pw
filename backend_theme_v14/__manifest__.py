...

{
    ...
    'assets': {
            'web.assets_backend': [
                '/backend_theme_v14/static/src/scss/colors.scss',
                '/backend_theme_v14/static/src/scss/style.scss',
                # '/backend_theme_v14/static/src/scss/sidebar.scss',
                # '/backend_theme_v14/static/src/js/sidebar.js',
                # '/backend_theme_v14/static/src/js/sidebar-toggle.js',
            ],
    }
